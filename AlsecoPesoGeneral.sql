...
SELECT al.idOrden,UPPER(al.nombreCliente) nombreCliente,al.sucursal,al.fechaCreado,al.nombrePrenda,IF(al.tipoServicio=1, 'Al seco','Al Agua') tipoServicio,al.total,al.modoPago,al.tipoPago coutas FROM 
...
al.fechaCreado BETWEEN '2017-04-28 00:00:00' AND '2017-04-28 23:59:59' AND  al.tipoServicio=1 
 UNION ALL
 /*PAGO TOTAL EFECTIVO Y VISA EN UNA SOLA CUOTA AL P*/
 SELECT al.idOrden,UPPER(al.nombreCliente) nombreCliente,al.sucursal,al.fechaCreado,al.nombreServicio nombrePrenda,IF(al.tipoServicio=1, 'Al seco','Al Agua') tipoServicio,al.total,al.modoPago,al.tipoPago coutas FROM 
...
al.fechaCreado BETWEEN '2017-04-28 00:00:00' AND '2017-04-28 23:59:59' AND  al.tipoServicio=2 ORDER BY idOrden
 UNION ALL
