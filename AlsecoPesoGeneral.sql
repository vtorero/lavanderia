...
al.fechaCreado BETWEEN '2017-05-04 00:00:00' AND '2017-05-04 23:59:59' AND  al.tipoServicio=2 
 UNION ALL
...
al.fechaCreado BETWEEN '2017-05-04 00:00:00' AND '2017-05-04 23:59:59' AND  al.tipoServicio IN(2)
 UNION ALL
/*PAGO PARCIAL EFECTIVO Y VISA EN DOS CUOTAS AL PESO AGUA*/
 ...
 (SELECT l.`item`,l.tipoServicio,o.idOrden,c.`nombreCliente`,p.fechaActualizado,pr.`nombrePrenda`,l.precio,l.cantidad,total,p.pago1,p.pago2,IF(tipoPago1=0,'Efectivo','Visa') modoPago,o.aplicaDscto,o.`tipoPago`,u.`sucursal` FROM Orden o 
 INNER JOIN OrdenLinea l ON o.idOrden=l.idOrden 
INNER JOIN  Prenda pr ON l.`idPrenda`=pr.`idPrenda`
INNER JOIN `cliente` c ON o.`idCliente`=c.`idCliente` 
INNER JOIN `usuario` u ON U.`id`=O.`idUsuario` 
 INNER JOIN Pago p ON o.idOrden=p.idOrden WHERE p.tipoPago IN(2) AND tipoPago1 IN(0,1) AND tipoPago2 IN (0,1) AND p.`Estado`=0) al WHERE 
al.fechaActualizado BETWEEN '2017-05-04 00:00:00' AND '2017-05-04 23:59:59' AND  al.tipoServicio IN(1) 
UNION ALL
...
al.fechaActualizado BETWEEN '2017-05-04 00:00:00' AND '2017-05-04 23:59:59' AND  al.tipoServicio IN(2)
UNION ALL
...
al.fechaActualizado BETWEEN '2017-05-04 00:00:00' AND '2017-05-04 23:59:59' AND  al.tipoServicio IN(2) order by idOrden;
